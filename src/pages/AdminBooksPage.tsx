          ...
          <form onSubmit={handleAddLibro} className="mb-6 flex flex-col gap-3 sm:gap-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-4">
              <input 
                ...
                required 
                placeholder="Título" 
                className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition bg-white text-gray-900 flex-1 text-sm sm:text-base" 
              />
              <input 
                type="text" 
                name="autor" 
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-4">
              ...
              <textarea 
                ...
                className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition bg-white text-gray-900 resize-none min-h-[80px] flex-1 text-sm sm:text-base" 
              />
            </div>
            ...
            {tipoFisico && (
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition bg-white text-gray-900 text-sm sm:text-base"
            ...
            <select 
              name="especialidad" 
              required 
              className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition bg-white text-gray-900 w-full text-sm sm:text-base" 
            >
            ...
            >
              ...
              <form onSubmit={handleEditLibro} className="flex flex-col gap-3 sm:gap-4 text-left" encType="multipart/form-data">
                ...
                <input 
                  ...
                  required 
                  placeholder="Título" 
                  className="border border-gray-300 rounded-lg px-3 sm:px-4 py-2 w-full bg-white text-gray-900 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-400 transition" 
                />
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        value={periodoTesis}
                        onChange={e => setPeriodoTesis(e.target.value)}
                        className="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition bg-white text-gray-900"
                        placeholder="Ej: 2023-2024"
                      />
                    </div>
                    <div className="flex flex-col gap-1">
