...
import { FaChartBar, FaBook, FaFileAlt, FaUserCheck, FaAngleDoubleLeft, FaAngleDoubleRight, FaBars, FaBuilding, FaSync, FaMoneyBillWave, FaCheckCircle, FaCalendarAlt, FaCashRegister } from 'react-icons/fa';
import { useState, useEffect } from 'react';
import { fetchUsuariosPendientes, fetchPagos } from '../services/bookService';
...
export default function AdminLayout() {
  ...
  const adminLinks = [
    ...
    { to: '/admin/centro-recaudacion', label: 'Centro de Recaudación', icon: <FaCashRegister /> },
  ...
  // AdminProtectedRoute ya verificó el rol; aquí solo mostramos el layout
  return (
