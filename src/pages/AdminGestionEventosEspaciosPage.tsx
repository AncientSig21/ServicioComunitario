  ...
  const cargarEventos = async () => {
    try {
      ...
      const eventosData: Evento[] = rows.map((r: any) => ({
        ...
        // Imagen desde la tabla archivos (join incluido en fetchAnuncios)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
      <div className="max-w-7xl mx-auto">
                      ...
                      {evento.imagen_url && (
                        <div className="flex-shrink-0">
                          <img
                            ...
                            alt={evento.titulo}
                            className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-lg cursor-pointer hover:opacity-90 transition-opacity border border-gray-200"
                            onClick={() => setImagenAmpliadaUrl(evento.imagen_url || null)}
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">
                              ...
                              {evento.imagen_url && (
                                <span className="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800">
                                  <FaImages className="mr-1" /> Con imagen
                                </span>
                              )}
                            </h3>
                            ...
                            <div className="flex flex-wrap gap-3 text-xs text-gray-500">
                              ...
                              {evento.fecha_evento && (
                                <span className="text-indigo-600 font-medium">
                                  🎉 Evento: {new Date(evento.fecha_evento).toLocaleDateString()}
                                </span>
                              )}
                              {evento.lugar && (
        ...
        {/* Modal para ver imagen ampliada del evento */}
        <AnimatePresence>
          {imagenAmpliadaUrl && (
            <div 
