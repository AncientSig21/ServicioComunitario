...
export const PaymentRequestModal: React.FC<PaymentRequestModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Monto es opcional, pero si se proporciona debe ser mayor a 0
    const montoValue = formData.monto ? parseFloat(formData.monto) : 0;
    if (formData.monto && montoValue <= 0) {
    ...
    try {
      ...
      await solicitarPago({
        ...
        monto: montoValue || 0, // Usar 0 si no se proporciona monto
        tipo: formData.tipo,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Si no especificas un monto, el administrador lo establecerá al revisar tu solicitud.
                </p>
              </div>
